...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mynx-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mynx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mynx transaction") + "\n" +
              "  mynx-tx [options] -create [commands]   " + _("Create hex-encoded mynx transaction") + "\n" +
              "\n";
