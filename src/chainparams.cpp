...
{
    const char* pszTimestamp = "31/03/2024, Meoooow";
    const CScript genesisOutputScript = CScript() << ParseHex("069784710fa689ad5023690a80e3e91c8f13f8d45b8c857fbcbc8ef6a8e4d3bd9b19e4b5133fa08ace601ace0a174830ff1b51850b4acf21b179c45070ac7b69e1") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 0.125 * 24 * 60 * 60; // 3 hours
        ...
        genesis = CreateGenesisBlock(1711895043, 2001151027, 0x1e0ffff0, 1, 6000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x84a2157bce9d926b76b9c2b4924690cc17a430c033604ad001e35976ea086efc"));
        assert(genesis.hashMerkleRoot == uint256S("0x9eadac3a138797dc48a4db52498c9a5d008f9230a94f84a3be4c5959f9fb263b"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("13.50.7.163", "13.50.7.163", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("mynxtools.com", "dnsseed.mynxtools.com"));
        //vSeeds.push_back(CDNSSeedData("mynxpool.org", "dnsseed.mynxpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x84a2157bce9d926b76b9c2b4924690cc17a430c033604ad001e35976ea086efc"))
        ...
        chainTxData = ChainTxData{
            ...
            1711629216, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1711895043, 528299, 0x1e0ffff0, 1, 6000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf0f63aac0e15c65f59890885ce017a272370fb31637d067ced67539662435bbb"));
        assert(genesis.hashMerkleRoot == uint256S("0x9eadac3a138797dc48a4db52498c9a5d008f9230a94f84a3be4c5959f9fb263b"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("13.50.7.163", "13.50.7.163"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.mynx.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xf0f63aac0e15c65f59890885ce017a272370fb31637d067ced67539662435bbb")),
        };
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 0.125 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 1 * 60;
        consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        genesis = CreateGenesisBlock(1711895043, 0, 0x207fffff, 1, 6000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x20f026c2f0a3f2def5e34b4e08c6d7edc1abbf2c91c04a5b6d877ad279d38a98"));
        assert(genesis.hashMerkleRoot == uint256S("0x9eadac3a138797dc48a4db52498c9a5d008f9230a94f84a3be4c5959f9fb263b"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x20f026c2f0a3f2def5e34b4e08c6d7edc1abbf2c91c04a5b6d877ad279d38a98"))
        };
